 ...
 */
final class Version20240328173931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, synonym VARCHAR(255) DEFAULT NULL, synonym_de VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, is_top BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE post (id INT NOT NULL, name VARCHAR(255) NOT NULL, subname VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, postcode VARCHAR(5) NOT NULL, city VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, status SMALLINT NOT NULL, small_image VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, web VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
